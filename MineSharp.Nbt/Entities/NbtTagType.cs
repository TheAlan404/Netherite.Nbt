namespace MineSharp.Nbt.Entities
{
    ...
    public static class NbtTagTypeExtensions
	{
        public static bool IsPrimitive(this NbtTagType tagType)
		{
            return tagType switch
            {
                NbtTagType.Byte => true,
                NbtTagType.Short => true,
                NbtTagType.Int => true,
                NbtTagType.Long => true,
                NbtTagType.Float => true,
