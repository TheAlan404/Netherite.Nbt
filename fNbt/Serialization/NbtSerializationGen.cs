...
namespace fNbt.Serialization {
    ...
    public class NbtSerializationGen {
        ...
        // new NbtString(string, string)
        static readonly ConstructorInfo NbtStringConstructor =
            typeof( NbtString ).GetConstructor( new[] { typeof( string ), typeof( string ) } );
        ...
        static List<Expression> MakePropertySerializers( Type type, ParameterExpression argValue,
            ...
            foreach( PropertyInfo property in GetSerializableProperties( type ) ) {
                ...
                if( propType == typeof( string ) ||
                    ...
                    propType == typeof( int[] ) ) {
                    Expression serializeStripPropExpr = SerializePropertyDirectly( argValue, varRootTag, property,
                        ignoreOnNull, tagName );
        ...
        static Expression SerializePropertyDirectly( ParameterExpression argValue,
            ParameterExpression varRootTag, PropertyInfo property, bool ignoreOnNull, string tagName ) {
        ...
        [NotNull]
        static NewExpression MakeTagForPrimitiveType( string tagName, Expression argValue,
            ...
            Debug.Assert( tagConstructor != null, "tagConstructor != null" );
